...
GCS_DB_PATH = "opioids_donut/opioids_donut-dev.duckdb"
GCS_PARQUET_DIR = "opioids_donut/tmp_parquet"
LOCAL_DB = "/tmp/app.duckdb"
SQL_DIR = Path(__file__).resolve().parent / "queries"

REQUIRED_TABLES = {"prescribing", "practices"}

TABLES_TO_BUILD = [
    ("prescribing", "vw__opioids_total_dmd_bs.sql"),
